...
class Front {
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'salsisync-front', SALSI_SYNC_URL . 'assets/build/main.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		// wp_enqueue_script( 'salsisync', SALSI_SYNC_URL . 'assets/build/main.js', array( 'jquery' ), $this->version, false );
